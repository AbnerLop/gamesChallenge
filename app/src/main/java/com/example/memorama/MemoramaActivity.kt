...
class MemoramaActivity : AppCompatActivity() {
    ...
    fun calculate(){
        if(firstCard == secondCard) {
            ...
            iv_11.setImageResource(R.drawable.notpressed)
            iv_12.setImageResource(R.drawable.notpressed)
            iv_13.setImageResource(R.drawable.notpressed)
            iv_14.setImageResource(R.drawable.notpressed)
            iv_21.setImageResource(R.drawable.notpressed)
            iv_22.setImageResource(R.drawable.notpressed)
            iv_23.setImageResource(R.drawable.notpressed)
            iv_24.setImageResource(R.drawable.notpressed)
            iv_31.setImageResource(R.drawable.notpressed)
            iv_32.setImageResource(R.drawable.notpressed)
            iv_33.setImageResource(R.drawable.notpressed)
            iv_34.setImageResource(R.drawable.notpressed)
